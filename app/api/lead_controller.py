...
class LeadController:
    ...
    def register_routes(self):
        ...
        async def register_lead(lead_data: Lead):
            ...
            self.twilio_service.send_message(lead_data.phone, get_welcome_message(lead_data.first_name, format_date_to_spanish_utc4(lead_data.event_date),"*20:00 hrs* 🇧🇴 / 19:00 hrs 🇪🇨 / 21:00 hrs 🇵🇾 "))
